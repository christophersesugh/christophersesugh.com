...
export default function About() {
  return (
    <section
      id="about"
      className="px-16 flex flex-col justify-center items-center gap-12 md:flex-row max-w-4xl mx-auto mt-32 md:my-40"
    >
      <Image
      ...
      <div>
        <h2 className="text-4xl">
          Hi, I am Christopher Aondona Sesugh. I am a software engineer and I
          love building quality software.
        </h2>
